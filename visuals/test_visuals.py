...
sns.lineplot(x='time', y='values', data=et_pivot1, ax=axs[0,0], hue = 'model_name', palette = 'colorblind') 
sns.scatterplot(x='aquacrop', y='values', data=et_pivot2, ax=axs[0,1], hue = 'model_name', palette = 'colorblind') 
...
ax=axs[2,1].axline((10, 10), slope=1, color = "grey")
ax=axs[0,1].set(ylim=(-5, 280), xlim=(-5,280))
ax=axs[1,1].set(ylim=(250, 800), xlim=(250,800))
ax=axs[2,1].set(ylim=(9.5, 15), xlim=(9.5,15))
